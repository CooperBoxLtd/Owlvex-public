...
import { evaluateFile } from '../gr001/evaluator.mjs';
import { normalizeExecutionRiskFinding } from './normalize-finding.mjs';
import { repoRoot } from '../../repo-root.mjs';

const corpusDir = path.resolve(repoRoot, 'tools/owlvex-benchmark/corpus/execution_risk_integration');
...
async function main() {
  ...
  console.log(JSON.stringify({
    suite: 'execution-risk-integration',
    passed,
